...
vjs.Player.prototype.loadTech = function(techName, source){
  ...
  var techReady = function(){
    ...
    if (!this.Map['progressEvents']) {
      this.player_.manualProgressOn();
    }

    // Manually track timeudpates in cases where the browser/flash player doesn't report it.
    if (!this.Map['timeupdateEvents']) {
...
vjs.Player.prototype.manualTimeUpdatesOn = function(){
  ...
  this.tech.one('timeupdate', function(){
    // Update known progress support for this playback technology
    this.Map['timeupdateEvents'] = true;
    // Turn off manual progress tracking
...
vjs.VolumeControl = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    if (player.tech && player.tech.Map && player.tech.Map['volumeControl'] === false) {
      this.addClass('vjs-hidden');
    }
    player.on('loadstart', vjs.bind(this, function(){
      if (player.tech.Map && player.tech.Map['volumeControl'] === false) {
        this.addClass('vjs-hidden');
      } else {
...
vjs.MediaTechController.prototype.Map = {
  'volumeControl': true,
...
vjs.Html5 = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    this.Map['volumeControl'] = vjs.Html5.canControlVolume();

    // In iOS, if you move a video element in the DOM, it breaks video playback.
    this.Map['movingMediaElementInDOM'] = !vjs.IS_IOS;

    // HTML video is able to automatically resize when going to fullscreen
    this.Map['fullscreenResize'] = true;
...
vjs.Html5.prototype.createEl = function(){
  ...
  if (!el || this.Map['movingMediaElementInDOM'] === false) {
